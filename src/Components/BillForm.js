...
function BillForm() {
  const { addBill, error, setError } = useGlobalContext();
    ...
    <FormStyled onSubmit={handleSubmit}>
      ...
      <div className="selects input-control">
        ...
        >
          ...
          <option value="Gas Cylinder Bills">Gas Cylinder Bills</option>
          <option value="Mobile recharge">Mobile recharge</option>
          <option value="Education Fees">Education Fees</option>
          <option value="Medical Bills">Medical Bills</option>
          <option value="Insurance Bills">Insurance Bills</option>
